...
module.exports = {
  ...
  module: {
    ...
    loaders: [
      ...
      // Assume node_modules css does not use local modules.
      {
        test: /\.css$/,
        include: /node_modules/,
        loader: ExtractTextPlugin.extract('style', 'css?importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!postcss')
      },
